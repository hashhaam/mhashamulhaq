...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 border-b border-line bg-bg/85 backdrop-blur-md">
      <Container as="nav" className="flex items-center justify-between py-[26px]">
        <Link
          href="/"
          className="flex items-center gap-[9px] font-display text-[20px] font-semibold tracking-[-0.02em] text-text"
        >
