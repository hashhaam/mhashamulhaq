...
- **2026-08-24 — Footer contact details refined.** Replaced generic footer arrows with contextual Lucide and brand icons, and added a visible WhatsApp contact using the owner-supplied `+923203487887` number with a direct `wa.me` link.
...
- Footer navigation uses contextual interface icons, while GitHub, LinkedIn, and WhatsApp use recognizable brand marks. WhatsApp links directly to the public phone number already defined in `site.links` so contact data remains centralized.
